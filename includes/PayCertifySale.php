...
function custom_credit_card_fields_golf_cc ($cc_fields , $payment_id){
    ...
    $cc_fields = array(
     ...
     'card-number-field' => '<p class="form-row form-row-wide">
        ...
        <input id="' . esc_attr( $payment_id ) . '-card-number" data-paycertify="card-number" type="text" autocomplete="off" placeholder="•••• •••• •••• ••••" name="' . esc_attr( $payment_id ) . '-card-number" />
     </p>',


     'card-expiry-field' => '<p class="form-row form-row-first">
        <label for="' . esc_attr( $payment_id ) . '-card-expiry">' . __( 'Expiry ( MM )', 'woocommerce' ) . ' <span class="required">*</span></label>
        <input id="' . esc_attr( $payment_id ) . '-card-expiry" data-paycertify="card-expiry-month" type="text" autocomplete="off" placeholder="' . __( 'MM', 'woocommerce' ) . '" name="' . esc_attr( $payment_id ) . '-card-expiry" />
     </p>',
     ...
     'card-year-field' => '<p class="form-row form-row-last">
        ...
        <input id="' . esc_attr( $payment_id ) . '-card-year" data-paycertify="card-expiry-year" type="text" placeholder="' . __( 'YY', 'woocommerce' ) . '" name="' . esc_attr( $payment_id ) . '-card-year" />
     </p>',
